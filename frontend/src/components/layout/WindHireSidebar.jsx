...
const WindHireSidebar = ({
  ...
  // All paths are under /products/windhire
  const menuItems = {
    candidate: [
      {
        name: "Dashboard",
  ...
  const commonItems = [
    {
      name: "Messages",
      icon: MessageSquare,
      path: "/products/windhire/messages",
    },
    {
      name: "Notifications",
      icon: Bell,
    ...
    { name: "Settings", icon: Settings, path: "/products/windhire/settings" },
  ];
    ...
    <>
      ...
      >
        <div className="flex items-center justify-between h-16 px-3 border-b border-border shrink-0">
          ...
          {isCollapsed && (
            <Link to="/products/windhire/dashboard" className="mx-auto">
        ...
        <div className="p-3 border-t border-border shrink-0">
          <Link
            to="/dashboard"
            className={cn(
              "flex items-center gap-3 w-full px-3 py-2.5 rounded-lg transition-colors text-muted-foreground hover:bg-accent hover:text-foreground",
              isCollapsed && "justify-center px-2",
            )}
          >
            <LayoutDashboard className="h-5 w-5 shrink-0" />
            {!isCollapsed && (
              <span className="text-sm font-medium">Platform Home</span>
            )}
          </Link>
        </div>
...
export default WindHireSidebar;
